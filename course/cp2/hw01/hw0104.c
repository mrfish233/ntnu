...
sRoom maze3[5][5] = {
    ...
    {{2, 0b10000100}, {3, 0b01001000}, {1, 0b01001000}, {2, 0b01000100}, {4, 0b01000000}}
};
...
// 無解情況迷宮5
sRoom maze5[4][3] = {
    {{1, 0b01110101}, {7, 0b11000011}, {2, 0b00100001}, {8, 0b00100010}},
    {{2, 0b00010001}, {5, 0b00100001}, {10, 0b00100001}, {2, 0b00100010}},
    {{9, 0b00010001}, {15, 0b00100001}, {7, 0b00100001}, {3, 0b00100010}},
};
...
int main() {
    ...
    switch (choice) {
        ...
        case 4:
            ...
            break;
        case 5:
            result = find_min_path((const sRoom *)maze5, 5, 5, &minPath);
            break;
        default:
            printf("無效的選擇。\n");
    }
